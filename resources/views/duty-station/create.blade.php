...
@section('title')
    Tambah Data Tempat Tugas | Sistem Informasi Kepegawaian
@endsection
    ...
    <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Tambah Data Tempat Tugas</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
              <div class="breadcrumb-item">Tambah Data Tempat Tugas</div>
            </div>
          </div>
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form action="{{ route('user.duty-station.store') }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
