...
@section('title')
    Tambah Pegawai | Sistem Informasi Kepegawaian
@endsection
          ...
          <div class="section-header">
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form action="{{ route('user.employee-list.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="">
                    @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 col-12">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_L" value="L" {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }}>>
                          ...
                          <div class="form-group col-md-6 col-12">
                              ...
                              <select name="tempat_tugas_id" id="tempat_tugas_id" class="form-control select2 @error('tempat_tugas_id') is-invalid @enderror">
                                  ...
                                  @foreach ($tempatTugas as $tempat_tugas)
                                      <option value="{{ $tempat_tugas->id }}" {{ old('tempat_tugas_id') == $tempat_tugas->id ? 'selected' : '' }}>
