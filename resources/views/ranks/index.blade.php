...
@section('title')
    Golongan | Sistem Informasi Kepegawaian
@endsection
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-ranks">
                        <thead>                                 
                          <tr>
                        ...
                        <tbody>   
                            @foreach ($golongans as $golongan)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <form action="{{ route('user.ranks.destroy', $golongan->id) }}" method="POST">
                                            <a href="{{ route('user.ranks.edit', $golongan->id) }}" class="btn btn-sm btn-warning btn-icon mt-1 mb-1"><i class="fas fa-edit"></i></a>
                                            @csrf
                                            @method('DELETE')
