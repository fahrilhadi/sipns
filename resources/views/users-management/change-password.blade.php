...
@section('admin-title')
    Ubah Password Pengguna | Sistem Supervisi Akademik
@endsection
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Ubah Password Pengguna</div>
            </div>
          </div>
          <div class="section-body">
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form action="{{ route('admin.users-management.change-password.update', $user->id) }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
